...
\begin{verbatim}
    ...
    #SBATCH --mem=<memory>              ## Assign memory, e.g., 32G memory per node 
\end{verbatim}
...
%\noindent A sample job script using \api{TMPDIR} is available at \texttt{/home/n/nul-uge/templateTMPDIR.sh}: 
...
%to an existing directory, \texttt{processed}
%working directory.
% TODO: verify:
