...
\noindent
Job scripts for the GPU queue differ in that they need this statement,
...
\noindent
You can query \tool{nvidia-smi} on the node running your job with:
\begin{verbatim}
  ssh <ENCSusername>@speed[-05|-17|37-43] nvidia-smi
\end{verbatim}
