...
% 2.1 Getting Started
% -------------------------------------------------------------
\input{02-job-management/2.1-getting-started.tex}
...
% -------------------------------------------------------------
\input{02-job-management/2.2-job-submission-basics.tex}
...
% -------------------------------------------------------------
\input{02-job-management/2.3-sample-job-script.tex}

% 2.4 Common Job Management Commands
% -------------------------------------------------------------
\input{02-job-management/2.4-common-job-commands.tex}

% 2.5 Advanced sbatch Options
% -------------------------------------------------------------
\input{02-job-management/2.5-advanced-sbatch-options.tex}

% 2.6 Array Jobs
% -------------------------------------------------------------
\input{02-job-management/2.6-array-jobs.tex}

% 2.7 Requesting Multiple Cores (i.e., Multithreading Jobs)
% -------------------------------------------------------------
\input{02-job-management/2.7-requesting-multiple-cores.tex}

% 2.8 Interactive Jobs
% -------------------------------------------------------------
\input{02-job-management/2.8-interactive-jobs.tex}
...
% -------------------------------------------------------------
\input{02-job-management/2.9-scheduler-env-variables.tex}

% 2.10 SSH Keys for MPI
% -------------------------------------------------------------
\input{02-job-management/2.10-ssh-keys.tex}

% 2.11 Creating Virtual Environments
% -------------------------------------------------------------
\input{02-job-management/2.11-creating-virtual-envs.tex}
...
% -------------------------------------------------------------
\include{02-job-management/2.12-ex-fluent.tex}

% 2.13 Example Job: EfficientDet
% -------------------------------------------------------------
\input{02-job-management/2.13-ex-efficiendet.tex}

% 2.14 Java Jobs
% -------------------------------------------------------------
\input{02-job-management/2.14-java-jobs.tex}

% 2.15 Scheduling on the GPU Nodes
% -------------------------------------------------------------
\input{02-job-management/2.15-scheduling-on-gpus.tex}
...
% -------------------------------------------------------------
\input{02-job-management/2.16-singularity-containers.tex}