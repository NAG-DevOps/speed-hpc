...
%
\titlerunning{Speed: The ENCS Cluster}
...
Let's look at a basic job script, \file{tcsh.sh} (you can copy it from \texttt{/home/n/nul-uge}):
...
\section{Advanced \tool{qsub} Options}
