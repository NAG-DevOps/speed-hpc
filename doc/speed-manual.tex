...
Create a ticket with the Service Desk (or email help at concordia.ca) to request that bash become your default login shell for your user account on all GCS servers.
...
\begin{itemize}
	...
	\end{verbatim}
	\item
	Update the job script to write output to the subdirectories you created in your speed\-scratch directory. For example, 	\textbf{\/speed\-scratch\/a\_user\/output}.
	\end{itemize}
\end{enumerate}
