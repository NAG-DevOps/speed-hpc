...
\tool{sbatch} command-line job (e.g., \texttt{salloc -J interactive-test --mem=1G -p ps -n 8}).
%
...
\item
verify you X connection was properly forwarded by printing the \api{DISPLAY} variable:
